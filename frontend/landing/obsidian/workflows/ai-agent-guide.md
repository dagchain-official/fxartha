...
| `superdesign` | The user wants to explore/compare design versions on the Superdesign canvas before implementation (installed globally at `~/.claude/skills/`, not in-repo) | [[superdesign]] |

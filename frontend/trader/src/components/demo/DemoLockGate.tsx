    ...
    <div className="min-h-[60vh] flex items-center justify-center p-4 sm:p-8">
      ...
      >
        ...
        <div className="mt-5 flex flex-col sm:flex-row gap-2 justify-center">
          <Link
            href="/auth/register"
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-[#ccff00] text-black text-sm font-bold hover:bg-[#a6d600] transition-colors shadow-[0_2px_8px_rgba(204,255,0,0.25)]"
          >

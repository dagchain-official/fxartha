...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: '/images/fxartha-logo.png', type: 'image/png' },
    ],
  },
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="alternate icon" href="/images/fxartha-logo.png" type="image/png" />
        <link rel="apple-touch-icon" href="/images/fxartha-logo.png" />
        <script

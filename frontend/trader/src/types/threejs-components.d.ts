 ...
 * shape rather than silenced with `any`.
 *
 * Mirrors `frontend/landing/src/types/threejs-components.d.ts` — both apps use
 * the same tubes cursor build, so keep the two in sync.
 *

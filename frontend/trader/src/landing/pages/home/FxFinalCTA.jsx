      ...
      <div className="fx-container py-20 md:py-28">
            ...
            <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <h2 className="text-3xl md:text-5xl lg:text-[56px] font-bold text-white leading-tight mb-4">
                  Start Trading With <span className="gradient-text">Full Control</span>
                </h2>
                <p
                  className="text-base md:text-lg max-w-xl"
                  style={{ color: 'var(--fx-text-2)' }}
                >
                  No custody risk. No hidden control. Just transparent, system-driven execution.
                </p>
              </div>
        ...
        <ScrollReveal variant="fadeUp" delay={0.2}>
          ...
          >
            ...
            automated and <span style={{ color: 'var(--fx-gold-light)' }}>control stays with you</span>.
          </p>
        </ScrollReveal>
      </div>
    </section>

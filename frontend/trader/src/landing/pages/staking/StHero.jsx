      ...
      <div className="fx-container relative z-10 w-full pt-28 md:pt-32 lg:pt-36 pb-8 md:pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            >
              Participate in the FX Artha protocol by providing liquidity — with flexible
              access or long-term benefits.
            </p>
            <p
              className="mt-4 text-sm md:text-base font-semibold fx-fade-up fx-fade-up-d2"
              style={{ color: 'var(--fx-gold-light)' }}
            >
              Your capital. Your control. Your choice.
            </p>
            <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4 fx-fade-up fx-fade-up-d3">
              <Link to="#plans" className="fx-btn-primary justify-center">
                Start Staking
                <ArrowRight size={18} />
              </Link>
              <Link to="#modes" className="fx-btn-ghost justify-center">
                Explore Options
              </Link>
            </div>
          </div>
